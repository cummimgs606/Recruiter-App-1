...
class PracticeLinkedAdmin {
	
	public static function init() {
	
		require_once (dirname(dirname(__FILE__)) .'/config/paths.php');
		require_once (PATH_SERVER.'core/form-languages/language-EN.php');
		...
		require_once (PATH_SERVER.'core/library/procedures-admin/practice/practice-linked.php');
		...
		if($_SERVER['HTTP_REFERER'] != URL_LOCALISED.'/index.php?header-menu=Practice-Linked'){
			$_SESSION['userList'] = '';	
		}
